...
## Fixed
- [#568](https://github.com/vadimcn/vscode-lldb/issues/568): Viewing a struct with union:s in C++ doesn't show all the member variables
- [#573](https://github.com/vadimcn/vscode-lldb/issues/573): Installing package flags "Unauthorized"

# 1.6.9

## Fixed
- [#465](https://github.com/vadimcn/vscode-lldb/issues/465): Incompatibility with arm64 macOS Monterey.
...
## Fixed
- [#527](https://github.com/vadimcn/vscode-lldb/issues/527): Breakpoints no longer triggering in library when using version 1.6.7
- [#540](https://github.com/vadimcn/vscode-lldb/issues/540): Rust printing of enums not working [for -windows-msvc targets]
- [#337](https://github.com/vadimcn/vscode-lldb/issues/337): Visualizing Vec<(f32,f32)> is showing as pointer
...
## Fixed
- Bug [#512](https://github.com/vadimcn/vscode-lldb/issues/512): External terminal no longer works since updating to v1.6.6
- Bug [#519](https://github.com/vadimcn/vscode-lldb/issues/519): Attaching to remote process using debugserver on Mac/iOS is not working.
- Bug [#522](https://github.com/vadimcn/vscode-lldb/issues/522): Conditional breakpoints don't trigger when empty logMessage is supplied.

# 1.6.6

## New
- Updated LLDB to 13.0.0
- Added [`debug_info`](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#debugger-commands) LLDB command, that makes it easier to determine which modules have debug info available.

## Fixed
- Bug [#474](https://github.com/vadimcn/vscode-lldb/issues/474): image dump sections causes the plugin to hang
- Bug [#480](https://github.com/vadimcn/vscode-lldb/issues/480): Panic: 'assertion failed: addr.is_valid()'

# 1.6.5

## Fixed
- Bug [#327](https://github.com/vadimcn/vscode-lldb/issues/327): Enums are not correctly displayed on MacOS.
- Bug [#451](https://github.com/vadimcn/vscode-lldb/issues/451): Debug Console doesn't work with version 1.6.4 on Windows.
- Bug [#454](https://github.com/vadimcn/vscode-lldb/issues/454): readMemory request does not accept negative offset.
...
- Upon completing a request, the [RPC server](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#rpc-server) will now respond with a status message.

# 1.6.4

## Fixed
- Bug [#411](https://github.com/vadimcn/vscode-lldb/issues/411): Cannot launch and connect to debugserver on Mac
- Bug [#412](https://github.com/vadimcn/vscode-lldb/issues/412): std::collectionHashMap/Set are not displayed (on x86_64-pc-windows-msvc)
- Bug [#435](https://github.com/vadimcn/vscode-lldb/issues/435): debug session exited unexpectedly
- Bug [#438](https://github.com/vadimcn/vscode-lldb/issues/438): Supply memoryReference for variables
- Bug [#439](https://github.com/vadimcn/vscode-lldb/issues/439): Debug session fails if I "watch" for a certain expression
- Bug [#440](https://github.com/vadimcn/vscode-lldb/issues/440): Nicer watch window messages with "native" expressions
- Bug [#442](https://github.com/vadimcn/vscode-lldb/issues/442): Rust std::collection::HashMap has no pretty printing

# 1.6.3

## Fixed
- Bug [#424](https://github.com/vadimcn/vscode-lldb/issues/424): 1.6.2 failure stopping at breakpoints
- Bug [#428](https://github.com/vadimcn/vscode-lldb/issues/428): Debugger fails to start (Fresh install / macOS 10.13)

# 1.6.2

## Fixed
- Bug [#417](https://github.com/vadimcn/vscode-lldb/issues/417): Loaded modules not shown.
...
- Added [RPC server](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#rpc-server) for "external" launching.
- Implemented new data watchpoint options (read vs write vs read/write).

# 1.6.1

## Fixed
- Bug [#395](https://github.com/vadimcn/vscode-lldb/issues/395) - Size and content of std::vector is not adjusted correctly after push_back.
...
## Other
- [Version 5.3](https://github.com/mozilla/rr/releases/tag/5.3.0) of Mozilla's [rr](https://rr-project.org/) has been released a few days ago.  It seems to work pretty well with CodeLLDB's [reverse debugging](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#reverse-debugging) support.
...
- The `.../command` [URL handler](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#starting-debug-session-outside-of-vscode) now supports setting debuggee environment variables.
...
- Added URL handler for [starting a debug session from outside of VSCode](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#starting-debug-session-outside-of-vscode).<br>
...
# 0.8.8
- Added [`postRunCommands`](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#launching).
- Bug fixes.
...
# 0.8.5
- Added support for [Cargo projects](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#cargo-support).
...
- Added `expressions` ∈ { `simple`, `python`, `native` } launch configuration property, which selects the default
  [expression evaluator type](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#expressions).
...
# 0.8.0
- Added [Parameterized Launch Configurations](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#parameterized-launch-configurations).
...
# 0.7.4
- It is now possible to set [default values for launch configurations](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#workspace-configuration) per-workspace.
...
# 0.3.3
- [Custom launch requests](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#custom-launch).
...
# 0.3.2
- Added pickProcess and pickMyProcess commands to be used with the **pid** parameter when [attaching](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/README.md#attaching).
...
# 0.3.0
- [Variable visualizers for Rust](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#rust-language-support).
- New [expression evaluator](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#expressions).
- Bug fixes.
...
# 0.2.0
- Added [disassembly view](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#disassembly-view).
- Added [variable formatting](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#formatting).

# 0.1.3
- Added support for setting variable values (primitive types only).
- Added [regex breakpoints](https://github.com/vadimcn/vscode-lldb/blob/v1.6.10/MANUAL.md#regex-breakpoints).
